...
namespace TMPro
{
    ...
    public class LeaderboardInputField : Selectable,
        ...
        IScrollHandler
    {
        ...
        protected LeaderboardInputField()
        {
        ...
        public float caretWidth { get { return m_CaretWidth; } set { if (SetPropertyUtility.SetStruct(ref m_CaretWidth, value)) MarkGeometryAsDirty(); } }
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (!isFocused && m_SelectionStillActive)
            {
                ...
                if (selectedObject != null && selectedObject != this.gameObject)
                {
                    ...
                    if (selectedObject.GetComponent<LeaderboardInputField>() != null)
                        ReleaseSelection();
